...
public class MAP {
    ...
    private static final String CREDENTIALS_FILE_PATH = "/pnc.json";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = MAP.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
...
//        ListMessagesResponse msgResponse = service.users().messages().list(user).execute();
